...
script.type = "module";
script.src = "../js/cyberCity/CyberCity.js";
var Info = {
  hasApt: false,
  AptInfo: [],
  CitizenInfo: [],
...
export var AptSave = {
  ...
  KitThingsOnTable:
    "../assets/cyberCity/Apts/Kitchen/ThingsOnDinnerTable/Style1.png",
  ...
  LivFurn:
    "../assets/cyberCity/Apts/Living Room/FurnitureOnLeftWindow/Style1.png",
  ...
  LivRightWindow:
    "../assets/cyberCity/Apts/Living Room/PlantsThingsNextToCouchRigtWindow/Style1.png",
  LivStuffMiniTable:
    "../assets/cyberCity/Apts/Living Room/StuffOnMiniTable/Style1.png",
...
const LoadAvailableBuildings = async () => {
  ...
  $.getJSON("../data/Apartments.json", function (json) {
    ...
    Info.AptInfo.push(Myjson[0]);
    Info.hasApt = true; // ------------------------------ For Testing Only ----------------------------------
...
const getAuctionsRawFur = async (walletAddress, arraya) => {
  getActiveAuctions(walletAddress).then((res) => {
    auctionsRaw = res;
