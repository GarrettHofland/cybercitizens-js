...
*/
export function extract_hints(signed_transaction: Transaction, state_context: ErgoStateContext, boxes_to_spend: ErgoBoxes, _data_boxes: ErgoBoxes, real_propositions: Propositions, simulated_propositions: Propositions): TransactionHintsBag;
/**
